...
export default function HomePage() {
  ...
  return (
    <>
      ...
      {/* Shorts → Regular Video Notice */}
      {(() => {
        const shortsMatch = submittedUrl && submittedUrl.match(/youtube\.com\/shorts\/([a-zA-Z0-9_-]{11})/);
        if (!shortsMatch || loading) return null;
        ...
        return (
          <div className="shorts-notice">
            ...
            <a href={watchUrl} target="_blank" rel="noopener noreferrer" className="shorts-notice-link">
